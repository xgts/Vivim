...
class CoolSystem(pl.LightningModule):
    ...
    def __init__(self, hparams):
        ...
        self.save_path='/home/lifan/wx/project/ultra/save_images_polyp2'
    ...
    def validation_step(self, batch, batch_idx):
        ...
        neigbor_1 = neigbor.squeeze(0)
        neigbor_1 = neigbor_1[self.nFrames // 2::self.nFrames]
        # print(neigbor_1.shape)
        filename = "neigbor_{}.png".format(batch_idx)
        save_image(neigbor_1, os.path.join(self.save_path, filename))
...
def main():
    RESUME = False
    resume_checkpoint_path = r'/home/lifan/wx/project/ultra/logs/uentm_polyp/version_2/checkpoints/ultra-epoch.ckpt'
    if RESUME == False:
